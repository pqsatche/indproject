...
<br>
<div class="col-md-4">
        <form name='basic' method='POST' action='cars.php' onSubmit='return validate();'>
                <table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
                        <tr><td colspan="2" style="text-align: center; border-radius: 5px; color: white; background-color:#333333;"><h2>Insert Car</h2></td></tr>
						<tr><td>Car: </td><td><input type='edit' name='car' value='' size='20'></td></tr>
